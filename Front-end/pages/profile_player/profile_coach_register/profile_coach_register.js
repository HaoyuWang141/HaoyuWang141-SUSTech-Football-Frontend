// pages/profile_player/profile_coach_register/profile_coach_register.js
const app = getApp()
      ...
      wx.request({
        ...
        success(res) {
          ...
          if (res.statusCode != 200) {
            console.error('新建教练失败' + res.statusCode + ' ' + res.data)
            return
          }
          console.log('新建教练成功')
          wx.navigateBack()
        ...
        fail(err) {
          console.error('新建教练失败：', err.statusCode, err.errMsg);
        },
        complete() {
          wx.hideLoading()
        }
